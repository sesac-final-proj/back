...
f8a9b0c1d2e3(price_model 계열)와 d2e3f4a5b6c7(admin_notices/community reactions
backfill + 681a93484e95 병합점)가 a4b5c6d7e8f9 이후로 각자 갈라진 채 병합 안 된
상태로 남아있던 걸 여기서 합친다(다른 스키마 변경 없이 head 두 개를 하나로 묶는
용도 겸용).

Revision ID: d1e2f3a4b5c6
Revises: f8a9b0c1d2e3, d2e3f4a5b6c7
...
down_revision: Union[str, Sequence[str], None] = ('f8a9b0c1d2e3', 'd2e3f4a5b6c7')
